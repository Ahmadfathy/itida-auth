...
export const translations = {
  en: {
    ...
    signInNowHint: 'You can now sign in using the form on the left.',
    ...
    enterUsernameEmail: 'Enter your username or company email',
    enterPassword: 'Enter your password',
    recoverNow: 'Validate my Identity',
    ...
    copyright: '© 2025 ITIDA. All rights reserved.',
    privacyPolicy: 'Privacy Policy',
    termsOfService: 'Terms of Service',
    cookiePolicy: 'Cookie Policy',
    contactLabel: 'Contact:',
    emailLabelFooter: 'Email:',
    ...
    usernameEmail: 'Username or Company Email',
    password: 'Password',
    ...
    username: 'Official Company Email',
    crn: 'Commercial Registry Number',
    licenseNo: 'ITIDA License Number',

    // User Roles
    userRole: 'User Role',
    identityTypeLabel: 'Identity Information',
    ...
    secureAccessDesc: 'Just one validation step to create or recover your ITIDA account',
    recoverYourAccount: 'Join ITIDA Now',
    recoverYourAccountDesc: 'Easily create or recover access to your ITIDA account with our secure recovery process',
  ...
  ar: {
    ...
    // Recovery confirmation
    passwordChangedTitle: 'تم تغيير كلمة المرور بنجاح',
    signInNowHint: 'يمكنك الآن تسجيل الدخول من النموذج في الصندوق المجاور.',
    accountDetails: 'تفاصيل الحساب',
    emailLabel: 'البريد الإلكتروني',
    crnLabel: 'السجل التجاري',
    licenseLabel: 'رقم الترخيص',

    // LoginForm additional
    accessAccountDesc: 'الوصول إلى حسابك في إيتيدا وإدارة أنشطتك في تكنولوجيا المعلومات والاتصالات',
    enterUsernameEmail: 'أدخل اسم المستخدم أو البريد الإلكتروني الرسمي للشركة',
    enterPassword: 'أدخل كلمة المرور',
    recoverNow: 'التحقق من هويتي الآن',
    ...
    copyright: '© 2025 إيتيدا. جميع الحقوق محفوظة.',
    privacyPolicy: 'سياسة الخصوصية',
    termsOfService: 'شروط الخدمة',
    cookiePolicy: 'سياسة ملفات تعريف الارتباط',
    contactLabel: 'التواصل:',
    emailLabelFooter: 'البريد الإلكتروني:',
    ...
    usernameEmail: 'اسم المستخدم أو البريد الإلكتروني الرسمي للشركة',
    ...
    username: 'البريد الإلكتروني الرسمي للشركة',
    crn: 'رقم السجل التجاري',
    licenseNo: 'رقم ترخيص نشاط تكنولوجيا المعلومات',

    // User Roles
    userRole: 'دور المستخدم',
    identityTypeLabel: 'معلومات الهوية',
    individual: 'فرد',
    company: 'شركة',
    government: 'حكومة',

    // Features
    featuresTitle: 'خدمات إيتيدا؟',
    licensing: 'الترخيص',
    ...
    secureAccessDesc: 'خطوة واحدة لإنشاء أو استعادة حسابك في إيتيدا',
    recoverYourAccount: 'إنشاء حسابك الآن',
    recoverYourAccountDesc: 'إنشاء حسابك الآن وتفعيله بسهولة من خلال عملية التسجيل الآمنة',
